...
| `mood` | 무드 선택 (9종: technical-report, clarity, tech-focus, growth, connection, innovation, knowledge, presentation, workshop) | - | clarity |
...
[Phase 0: 입력 검증 및 초기화]
    ...
    |   +-- theme 유효성 검증 (concept, gov, seminar, whatif, pitch, comparison)
    |
