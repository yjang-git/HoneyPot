...
| leadership-analyst | `macro-analysis:leadership-analyst` | 주요국 리더십 및 중앙은행 분석 |
...
| `leadership-analysis.json` | leadership-analyst | 리더십 분석 (JSON) |
...
```json
{
  ...
  "output_files": [
    ...
    "consultations/2026-01-14-TSLA-abc123/macro-outlook.json",
    "consultations/2026-01-14-TSLA-abc123/leadership-analysis.json",
