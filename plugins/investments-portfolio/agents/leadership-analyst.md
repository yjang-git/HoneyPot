...
> - Write 도구로 `01-leadership-analyst.md` 저장 필수
> - 저장 실패 시 FAIL 반환
...
*Generated by leadership-analyst agent*  
...
| `01-leadership-analyst.md` | 사람이 읽는 Markdown 보고서 | ✅ |
...
Write(
  file_path="portfolios/YYYY-MM-DD-{profile}-{session}/01-leadership-analyst.md",
  content="[보고서 내용]"
)
```
...
- Markdown: portfolios/YYYY-MM-DD-{profile}-{session}/01-leadership-analyst.md
```
...
### 출력 경로
output_path: portfolios/{session_folder}/01-leadership-analyst.md
