...
[Phase 2: 데이터 변환]
    ...
    |   +-- 스크립트 경로: plugins/investments-portfolio/skills/data-updater/scripts/update_fund_data.py
    |   +-- 실행 명령어:
...
python honeypot/plugins/investments-portfolio/skills/data-updater/scripts/update_fund_data.py \
  --file [csv_file_path]
```
...
```bash
python plugins/investments-portfolio/skills/data-updater/scripts/classify_funds.py \
...
- **메인 스크립트**: `plugins/investments-portfolio/skills/data-updater/scripts/update_fund_data.py`
- **분류 스크립트**: `plugins/investments-portfolio/skills/data-updater/scripts/classify_funds.py`
